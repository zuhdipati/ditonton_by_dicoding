...
void main() {
  ...
  group('get Now Playing Movies', () {
    final tMovieList = MovieResponse.fromJson(
      json.decode(readJson('movies/dummy_data/now_playing.json')),
    ).movieList;
      ...
      () async {
        ...
        when(
          ...
          (_) async => http.Response(
            readJson('movies/dummy_data/now_playing.json'),
            200,
          ),
        );
        // act
  ...
  group('get Popular Movies', () {
    final tMovieList = MovieResponse.fromJson(
      json.decode(readJson('movies/dummy_data/popular.json')),
    ).movieList;
    ...
    test(
      ...
      () async {
        ...
        when(
          ...
          (_) async =>
              http.Response(readJson('movies/dummy_data/popular.json'), 200),
        );
        // act
  ...
  group('get Top Rated Movies', () {
    final tMovieList = MovieResponse.fromJson(
      json.decode(readJson('movies/dummy_data/top_rated.json')),
    ).movieList;
    ...
    test('should return list of movies when response code is 200 ', () async {
      ...
      when(
        ...
        (_) async =>
            http.Response(readJson('movies/dummy_data/top_rated.json'), 200),
      );
      // act
  ...
  group('get movie detail', () {
    ...
    final tMovieDetail = MovieDetailResponse.fromJson(
      json.decode(readJson('movies/dummy_data/movie_detail.json')),
    );
    ...
    test('should return movie detail when the response code is 200', () async {
      ...
      when(
        ...
        (_) async =>
            http.Response(readJson('movies/dummy_data/movie_detail.json'), 200),
      );
      // act
  ...
  group('get movie recommendations', () {
    final tMovieList = MovieResponse.fromJson(
      json.decode(readJson('movies/dummy_data/movie_recommendations.json')),
    ).movieList;
    final tId = 1;
    ...
    test(
      ...
      () async {
        ...
        when(
          ...
          (_) async => http.Response(
            readJson('movies/dummy_data/movie_recommendations.json'),
            200,
          ),
        );
        // act
  ...
  group('search movies', () {
    final tSearchResult = MovieResponse.fromJson(
      json.decode(readJson('movies/dummy_data/search_spiderman_movie.json')),
    ).movieList;
    ...
    test('should return list of movies when response code is 200', () async {
      ...
      when(
        ...
        (_) async => http.Response(
          readJson('movies/dummy_data/search_spiderman_movie.json'),
          200,
        ),
      );
      // act
