...
void main() {
  ...
  group('DatabaseHelper Test', () {
    test('watchlist movie', () async {
      ...
      final deleteResult = await databaseHelper.removeMovieWatchlist(tMovieTable);
    ...
    test('watchlist tv series', () async {
      ...
      final deleteResult = await databaseHelper.removeTvSeriesWatchlist(tTvSeriesTable);
      expect(deleteResult, 1);
